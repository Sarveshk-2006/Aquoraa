    ...
    def __init__(self):
        ...
        self._fixtures: list[CandidateResult] = [
            CandidateResult(
                ...
                name="TEST INTERVENTION CANDIDATE A — Kurla Junction Inlet Clearance",
                ...
                summary="TEST INTERVENTION CANDIDATE A (Kurla Junction Drainage Inlet)",
                provenance={
            ...
            CandidateResult(
                ...
                name="TEST INTERVENTION CANDIDATE B — Saki Naka Road Access Protection",
                ...
                summary="TEST INTERVENTION CANDIDATE B (Saki Naka Corridor)",
                provenance={
                    "provider": self.provider_id,
                    "provider_mode": self.provider_mode,
                    "environment": self.environment,
            ...
            CandidateResult(
                ...
                name="TEST INTERVENTION CANDIDATE C — Kalina Hospital Access Protection",
                ...
                summary="TEST INTERVENTION CANDIDATE C (Hospital Approach Corridor)",
                provenance={
                    "provider": self.provider_id,
                    "provider_mode": self.provider_mode,
                    "environment": self.environment,
            ...
            CandidateResult(
                ...
                name="TEST INTERVENTION CANDIDATE D — Sion Dewatering Review Location",
                ...
                summary="TEST INTERVENTION CANDIDATE D (Sion Lowland Dewatering Location)",
                provenance={
                    "provider": self.provider_id,
                    "provider_mode": self.provider_mode,
                    "environment": self.environment,
            ...
            CandidateResult(
                ...
                name="TEST INTERVENTION CANDIDATE E — Mithi River Outfall Capacity Review",
                ...
                summary="TEST INTERVENTION CANDIDATE E (Mithi River Outfall Bottleneck)",
                provenance={
                    "provider": self.provider_id,
                    "provider_mode": self.provider_mode,
                    "environment": self.environment,
